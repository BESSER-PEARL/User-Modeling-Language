...
|---------------------|-------------|-----------|
| Education | Reflects the different degrees/diplomas the user possesses and their corresponding fields. |  [5] [9] [14]|
| Skill |The user's proficiency in performing specific tasks or actions. | [4] [7] [8] [9] [12] [14] [16] [19] [23] |
| Language | The user's spoken languages in iso693_3 format, using the CEFR language levels to describe the mastery. | [14] [16] [22] |
| Knowledge | The user's understanding, awareness, or familiarity with concepts, facts, or subjects. | [1] [4] [7] [8] [11] [13] [14] [19] [23] |
| Experience | Previous or current professional experiences of the user. | [1] [4] [5] [7] [9] [11] [10] [12] [13] [14] [19] [23] |
