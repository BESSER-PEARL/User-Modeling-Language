...
|------------|-------------|-----------|  
| Interaction modality | Preferred interaction modality of a user.| [2] [22] |
| Design | Preferences related to design aspects (e.g., color scheme, text size, police,...) of an application.| [2] [18] [21] [22]  |
| Item | Set of personal priorities given a list of choices.| [3] [10]  |
| PreferredLanguage | Preferred interaction language for a given application.| [12] [18]  |
