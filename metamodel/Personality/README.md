...
|------------|-------------|-----------|  
| Attitude | Tackles a user’s opinion given a topic, be it of a negative or positive nature.|  [1] [7] [11] [20]|
| Bias | Stronger and more negative version of Attitude, often leading to an unfair treatment of a target. | [8] [34] |
| InterpersonalMotivation | Attributes describing the importance a user attributes to social factors. | [35] |
| IntraphysicMotivation | Attributes describing the importance a user attributes to self-actualization, such as reaching one's full potential. | [35] |
| InstrumentalMotivation | Attributes describing the importance a user attributes to satisfaction with material outcomes of activity. | [35] |
| Trait | People’s pattern of thoughts, feelings and behaviors  | [28] |
| BigFiveTraits | Group of five traits used to study personality. | [36] |
| MyersBriggsTypeInventory| Group of 16 distinct personality types.  | [28] |
| Characteristic |Observable and concrete feature of a person implied by a trait. | [28]  |
